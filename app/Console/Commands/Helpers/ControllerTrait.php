...
trait ControllerTrait
{
    protected function inputAsArray($key, $type = 'text')
    {
        ...
        if ($type == 'text') {
            ...
            $out .= "\t\t\t\t\t\t\t\t" . '<a class="btn btn-danger" href="{{ url("deleteFile/' . strtolower($this->getNameInput()) . '/".$item->id."?name=".$jsonimage."&filed_name=' . $keyWithOutBrakets . '") }}"><i class="fa fa-trash"></i></a></div>' . "\n";
            $out .= "\t\t\t\t\t\t\t" . '@endforeach' . "\n";
            $out .= "\t\t\t\t\t\t\t" . '</div>' . "\n";
             $out .= "\t\t\t\t\t\t\t" . '<div class="row text-center">' . "\n";
            ...
            $out .= "\t\t\t\t\t\t\t\t" . '<a  href="{{ url("deleteFile/' . strtolower($this->getNameInput()) . '/".$item->id."?name=".$jsonimage."&filed_name=' . $keyWithOutBrakets . '") }}"><i class="fa fa-trash"></i> {{ $jsonimage }} </a></div>' . "\n";
            $out .= "\t\t\t\t\t\t\t" . '@endforeach' . "\n";
            $out .= "\t\t\t\t\t" . '</div>' . "\n";
            $out .= "\t\t\t\t\t\t" . '@endif' . "\n";
            $out .= "\t\t\t\t\t" . '@endisset' . "\n";
