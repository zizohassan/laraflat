...
@push('header')
    <button class="btn btn-danger" onclick="deleteThemAll(this)" data-link="{{ url('admin/setting/pluck') }}" ><i class="fa fa-trash"></i> </button>
...
@push('search')
    <form method="get" class="form-inline">
        ...
        <a href="{{ url('admin/setting') }}" class="btn btn-danger" ><i class="fa fa-close"></i></a>
    </form>
@endpush
