        ...
        <form action="{{ concatenateLangToUrl('admin/permission/item') }}{{ isset($item) ? '/'.$item->id : '' }}" method="post" enctype="multipart/form-data">
                ...
                <div class="">
                    <div class="col-sm-6">
                        <div class="">
                            ...
                            <label> {{ trans('permission.action_add') }}  {!! Form::select('action_add' , permissionType() , $add , ['calss' => 'form-control']) !!}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="">
                            ...
                            <label>{{ trans('permission.action_delete') }} {!! Form::select('action_delete' , permissionType() , $delete , ['calss' => 'form-control']) !!}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="">
                            ...
                            <label>{{ trans('permission.action_view') }} {!! Form::select('action_view' , permissionType() , $view , ['calss' => 'form-control']) !!}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="">
                            ...
                            <label>{{ trans('permission.action_edit') }} {!! Form::select('action_edit' , permissionType() , $edit , ['calss' => 'form-control']) !!}</label>
                        </div>
                    </div>
            ...
            <div class="form-group">
                <button type="submit" name="submit" class="btn btn-default" >
                    ...
                    {{ trans('home.save') }} {{ trans('permission.permission') }}
                </button>
            </div>
        </form>
    @endcomponent
